...
const ItemWallet = (props: IProps) => {
        ...
        return (
            <>
                <ViewTop>
                    ...
                    <ButtonOpen>
                        <Text type="m_8_10">Tap to open</Text>
                    </ButtonOpen>
                </ViewTop>
                <ViewBalance>
                    ...
                    <ButtonShow hitSlop={hitSlop} onPress={onShowBalancePressed}>
                        <SVGIcon name={showBalance ? 'ic-eye-off' : 'ic-eye'} size={scales(24)} color={Colors.white} />
                    </ButtonShow>
                </ViewBalance>
            </>
        );
    ...
    return (
        <Wrapper disabled={!isNew} isNew={isNew} onPress={onWalletPressed} {...props}>
            {isNew ? renderNewItem() : renderDetailWallet()}
            <ImageBG source={Images.BGItemWallet} tintColor={isNew && Colors.green1} />
        </Wrapper>
    );
};
